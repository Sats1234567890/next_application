...
export default function TeamMemberPage({ params }: Params) {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-lg flex flex-col md:flex-row gap-6 relative">
      {/* Back Button */}
      <button
        onClick={() => router.back()}
        className="absolute top-4 left-4 flex items-center gap-1 text-green-600 font-medium hover:text-green-800"
      >
        <ArrowLeft size={20} />
        Back
      </button>
      ...
      <div className="md:w-1/3 flex flex-col items-center gap-4 mt-10 md:mt-0">
        <Image
          src={member.image}
          alt={member.name}
          width={400}
      ...
      <div className="md:w-2/3 relative flex flex-col p-4 rounded-lg overflow-hidden mt-10 md:mt-0">
        ...
        <div className="relative flex-grow">
          ...
          {/* Details Section */}
          <div className="relative z-10 space-y-3 text-gray-700 pb-4">
